...
<div class="row">
    <div class="large-6 columns">
        <h2>Settings</h2>
        <form action="settings-action.php" method="post" data-abide>
          <h3>Change Password</h3>
          <div>
          <label>Old Password
            <input type="password" id="password" placeholder="Enter Password" name="password" required pattern="password"/>
          </label>
          <small class="error">Alphanumeric password is required. (Minimum 8 characters, both uppercase and lowercase)</small>
          </div>
          <div>
          <label>New Password
            <input type="password" id="password1" placeholder="Enter Password" name="password1" required pattern="password"/>
          </label>
          <small class="error">Alphanumeric password is required. (Minimum 8 characters, both uppercase and lowercase)</small>
          </div>
